...
set top(NAggr)		2	;# Number of Switches in AGGREGATION network 
set top(NAccess)		4			;# Number switches in ACCESS network per pod
set top(NRackHosts)		4			;# Number of Hosts on a rack
